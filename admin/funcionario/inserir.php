...
<head>
    ...
    <title>Kingsen - funcionario</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 mb-2 text-center">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input type="text" name="rg" maxlength="12" data-mask="00.000.000-A" class="form-control" required>
                                        </div>
                                        <!--  -->
                                        <div class="col-12">
                                            <h5>Contatos:</h5>
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input type="tel" name="telefone" maxlength="13" data-mask="(000)0000-0000" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <label for="cargo"><strong class="text-danger">*</strong>Cargos: </label>
                                            <select class="form-control" name="cargo">
                                                ...
                                                do {
                                                    echo '<option value="' . $cargo['id_cargo'] . '" >' . $cargo['nome_cargo'] . '</option>';
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="salario" maxlength="8" data-mask="0000000,00" data-mask-reverse = true class="form-control" required>
                                        </div> 
                                ...
                                <input type="hidden" value="cadastrar_funcionario" name="cadastrar_funcionario" >
                            </form>
                        </div>
                    </div>
                </div>
