...
if (isset($_POST['atualizar']) && $_POST['atualizar'] == 'atualizar_produto') {
    ...
    $sql= "UPDATE produto SET descricao = '$descricao', nome = '$nome', preco_venda = '$preco_venda', foto = '$foto', preco_promocao = '$preco_promocao', estoque = '$estoque', status = $status, preco_custo =  '$preco_custo', lucro = '$preco_lucro', status_promocao = $status_promocao , porcentagem = '$porcentagem', id_marca = $id_marca, id_categoria = $id_categoria";
