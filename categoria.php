    ...
    <div class="mainpage-container">
        <div class="container" style="margin-top: 11rem;">
            ...
            if (isset($_GET['id_categoria']) && $_GET['id_categoria'] != '') {
                ...
                $sql_cont = "select id_produto from produto where id_categoria = $categoria";
                ...
                $buscapag = "&id_categoria=" . $categoria;
                ...
                $sql = "SELECT * FROM produto p where p.status = 1 and p.id_categoria = $categoria limit $valorInicial, $paginaQtdd";
            ...
            ?>
                <div class="row justify-content-center text-center">
                    ...
                    ?>
                        <div class="col-lg-3">
                            <div class="card mt-3" style="box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">
                                <div class="div-img">
                                    <?php
