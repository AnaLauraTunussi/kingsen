    ...
    <div class="mainpage-container">
        <div class="container" style="margin-top: 10rem;">
            ...
            if (isset($_GET['busca']) && $_GET['busca'] != '') {
                ...
                $sql_cont = "select id_produto from produto where nome like '%$buscar%'";
                ...
                $sql = "SELECT * FROM produto p where p.status = 1 and p.nome like '%$buscar%' limit $valorInicial, $paginaQtdd";
